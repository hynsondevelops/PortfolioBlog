...
chessImage1 = Image.create(img: fixture_file_upload(Rails.root.join('app', 'assets', 'images', 'ChessCheckMate.png'), 'image/png')) 
chessImage2 = Image.create(img: fixture_file_upload(Rails.root.join('app', 'assets', 'images', 'ChessStart.png'), 'image/png'))
